...
figure = px.scatter(data_frame=data, x="TV", y="Sales", size="TV", trendline="ols",  color="Sales", color_continuous_scale=['red'],
...
figure = px.scatter(data_frame=data, x="Newspaper", y="Sales", size="Newspaper", trendline="ols",  color="Sales", color_continuous_scale=['red'],
...
figure = px.scatter(data_frame=data, x="Radio", y="Sales", size="Radio", trendline="ols",  color="Sales", color_continuous_scale=['red'],
